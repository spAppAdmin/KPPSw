...
namespace ImportListFromCSV
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                 UploadKPICSV();
                 P.GeneralLogging.AddStatusLog("CSVLoader","Completed Successfully");
            ...
            catch (CsvHelper.CsvHelperException ex)
            {
                ...
                P.GeneralLogging.AddExceptionLog(ex, "CSVLoader");
            }
        ...
        public static void UploadKPICSV()
        {
            ...
            //String sourcePath = @"c:\temp\ProjectKPI.csv";
            //string sourcePath = @"\\eho-erp-ln2\Transfer\Tisoware\151\";
            //string fileName = "ProjectKPI.csv";

            //string targetPath = @"\\kineticsys.sharepoint.com\sites\IntranetPortal\adm\ETL\CSVFiles\ProjectKPI.csv";


            string targetPath = @"\\kpilistprocessingfuncsto.file.core.windows.net\csvfilestorage\ProjectKPI.csv";

            //string targetPath = @"C:\temp\ProjectKPI.csv";
            ...
            try
            {
                ...
                if (ctx != null)
                {
                    List<CsvRecord> records = GetRecordsFromCsv(targetPath);

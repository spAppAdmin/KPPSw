...
namespace SPHelpers
{
    ...
    public class GeneralLogging
    {
        ...
        public static void WriteExceptionToLog(Exception ex)
        {
            ...
            Uri projSiteUrl = new Uri(ConfigurationManager.AppSettings["AppLogUrl"].ToString());
                ClientContext ctx = getProjectSpCtx(projSiteUrl);
                AddNewListItem(ex, ctx);

                //exception.Data["SomeData"] = new List<string>();
        ...
        //Add new list item 
        public static void AddNewListItem(Exception ex,ClientContext ctx)
        {
            ...
            oListItem["title"] = "Exception";
           // oListItem["Message"] = ex.Message;

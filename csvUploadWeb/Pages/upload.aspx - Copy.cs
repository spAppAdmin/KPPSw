...
namespace csvUploadWeb.Pages
{
    public partial class upload : System.Web.UI.Page
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(msg, this.GetType(), "AlertMsg", "<script language='javascript'>alert('dddsssddd');</script>", false);
            getProjectList();
        }
        ...
        public static UploadCSV() { 
            TextBox csvFilex = (TextBox)csvFile;

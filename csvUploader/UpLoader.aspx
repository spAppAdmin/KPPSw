...
<body>
    <form id="frm" runat="server">
        ...
        <div id="MainContent">
            <asp:UpdateProgress ID="updProgress"  runat="server" AssociatedUpdatePanelID="UpdatePanel">
                <ProgressTemplate>
          ...
          <div>
            ...
            <table id="frmtbl">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="csvFile" runat="server" Width="600" CssClass="w3-auto" EnableTheming="True" CausesValidation="true" accept=".csv" ></asp:TextBox>
